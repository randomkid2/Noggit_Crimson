...
`.claude/hooks/guard-db.ps1` is the real write guard. Record its limits honestly — anything it
cannot intercept is a risk you are carrying, not one that has been removed.
