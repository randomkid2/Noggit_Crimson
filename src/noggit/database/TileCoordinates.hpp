...
namespace Noggit::Database
{
  ...
  namespace TileCoordinates
  {
    ...
    // World-space bounds of a tile. max is exclusive: a position exactly on the boundary
    // belongs to exactly one tile, and tileForPosition is the authority on which.
